...
from dTOKENA import JackTokenize
from JackTokenizer import JackTokenizer
from danieljack import CompilationEngin
...
def compile_file(
    ...
    # compilation_engine = CompilationEngin(tokenizer, output_file)
    # compilation_engine.compile_class()

    cp = CompilationEngine(JackTokenizer(input_file) , output_file)
